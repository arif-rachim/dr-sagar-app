...
export function Banner(){
    return <div style={{display:'flex',flexDirection:'column',alignItems:'center',padding:'3rem 1rem',boxShadow:'0 15rem 70rem -5rem rgba(255,255,255,0.3) inset',color:'rgba(255,255,255,0.8)',textAlign:'center',minHeight:'80vh',background:'linear-gradient(180deg, rgba(206,243,199,1) 0%, rgba(16,64,83,1) 130%)'}}>
        ...
        <motion.h1 style={{fontFamily:'Tenor Sans',letterSpacing:'0.1rem',margin:'3rem 0',color:colors.second}} initial={{opacity:0,y:100}} animate={{opacity:1,y:0}} transition={{delay:0.1,duration:0.5}}>SAGARS HOMEOPATHY FOR KIDS</motion.h1>
        <motion.h3 style={{fontWeight:300,margin:0,padding:0,fontSize:'0.9rem',letterSpacing:'0.15rem'}} initial={{opacity:0,y:100}} animate={{opacity:1,y:0}} transition={{delay:0.15,duration:0.5}}>A Video consultation Platform by,</motion.h3>
